-- Remover função existente para alterar tipo de retorno
DROP FUNCTION IF EXISTS public.get_seller_average_rating(UUID);

-- Criar nova função para calcular média ponderada de avaliações
