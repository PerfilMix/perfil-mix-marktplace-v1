...
const PaymentButton = ({
  ...
  if (!isAuthenticated) {
    ...
    }} size="lg" className="w-full py-3 font-semibold min-w-0 sm:py-6 text-sm sm:text-lg px-[24px]">
        <div className="flex items-center justify-between w-full gap-2 px-[70px]">
