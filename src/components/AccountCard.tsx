        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-2">
          ...
          <div className="flex-1 space-y-3 lg:space-y-6">
            ...
            <div className="space-y-2 lg:space-y-3">
              <div className="flex justify-start items-center py-2 bg-tech-darker/50 rounded-lg border border-tech-accent/10 px-3 lg:px-6 mx-[5px] gap-2 whitespace-nowrap">
